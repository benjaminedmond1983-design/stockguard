...
const CASHIER_TABS = [
  "Sales", "Receiving", "Movements", "Reorder Center"
];
...
function LoginScreen({onLogin}){
  ...
  function tryOwnerLogin(){
    if(pin===OWNER_PIN){onLogin("owner");}
  ...
  if(showPin) return(
    <div style={{minHeight:"100vh",background:"#EEF2F7",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"system-ui,-apple-system,sans-serif"}}>
      <div style={{background:"#fff",borderRadius:16,padding:"40px 36px",width:340,boxShadow:"0 4px 24px rgba(0,0,0,0.10)"}}>
        <button onClick={()=>{setShowPin(false);setPin("");setPinError("");}} style={{background:"none",border:"none",color:"#666",fontSize:13,cursor:"pointer",marginBottom:20,padding:0}}>← Back</button>
        ...
        <button onClick={tryOwnerLogin} style={{width:"100%",padding:"11px",borderRadius:8,border:"none",background:"#1B2B4B",color:"#fff",fontWeight:700,fontSize:14,cursor:"pointer",marginTop:4}}>Unlock Owner View</button>
      </div>
    </div>
  );
    ...
    <div style={{minHeight:"100vh",background:"#EEF2F7",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"system-ui,-apple-system,sans-serif"}}>
      <div style={{background:"#fff",borderRadius:16,padding:"48px 40px",width:380,boxShadow:"0 4px 24px rgba(0,0,0,0.10)",textAlign:"center"}}>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginBottom:32}}>
          <svg width="48" height="48" viewBox="0 0 40 40" fill="none"><rect width="40" height="40" rx="10" fill="#1B2B4B"/><text x="4" y="28" fontSize="22" fontWeight="700" fill="#ffffff" fontFamily="system-ui">S</text><text x="19" y="28" fontSize="22" fontWeight="700" fill="#ffffff" fontFamily="system-ui">G</text><rect x="33" y="10" width="2" height="10" rx="1" fill="#ffffff" opacity="0.9"/><rect x="30" y="13.5" width="8" height="2" rx="1" fill="#ffffff" opacity="0.9"/></svg>
        ...
        {/* Cashier button */}
        <button onClick={()=>onLogin("cashier")} style={{width:"100%",padding:"18px 20px",borderRadius:12,border:"2px solid #0F6E56",background:"#0F6E56",color:"#fff",cursor:"pointer",display:"flex",alignItems:"center",gap:16,textAlign:"left"}}>
          <span style={{fontSize:28}}>🧾</span>
          <div>
        ...
        <div style={{marginTop:32,fontSize:11,color:"#aaa",fontStyle:"italic"}}>"Commit to the Lord whatever you do"<br/>Proverbs 16:3</div>
      </div>
    </div>
  );
}
...
export default function App(){
  const [role,setRole]=useState(null); // null = login screen, "owner" or "cashier"
  ...
  return <AppInner role={role} onLogout={()=>setRole(null)} TABS={TABS}/>;
}

function AppInner({role,onLogout,TABS}){
    ...
    <div style={{display:"flex",minHeight:"100vh",fontFamily:"system-ui,-apple-system,sans-serif",color:C.text,background:"#EEF2F7"}}>
      <div style={{width:SIDEBAR_W,minWidth:SIDEBAR_W,background:SIDEBAR,display:"flex",flexDirection:"column",position:"fixed",top:0,left:0,height:"100vh",zIndex:100,overflowY:"auto"}}>
        <div style={{padding:"24px 16px 20px",borderBottom:"1px solid rgba(255,255,255,0.08)"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            ...
            <div>
              ...
              <div style={{color:"rgba(255,255,255,0.5)",fontSize:10,marginTop:3}}>{isOwner?"Owner View":"Cashier View"}</div>
            </div>
          </div>
          {/* Role badge */}
        ...
        <div style={{padding:"16px",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
          <button onClick={onLogout} style={{width:"100%",padding:"8px",borderRadius:8,border:"1px solid rgba(255,255,255,0.2)",background:"transparent",color:"rgba(255,255,255,0.6)",fontSize:12,cursor:"pointer",marginBottom:12}}>
            🔄 Switch Role
          </button>
